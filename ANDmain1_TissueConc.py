...
# main function
def main():
    headers = "bird.id","sex","treatment","tissue.type","total.carot.conc"
    # get input from user
    ...
    col0, col1, col2, col3, col4 = geou.getOutput_conc(bird)
    list_rows = geou.colToRow(col0, col1, col2, col3, col4)
